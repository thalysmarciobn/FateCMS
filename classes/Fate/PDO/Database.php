...
use Fate\PDO\Statement\SelectStatement;
use Fate\PDO\Statement\InsertStatement;
use Fate\PDO\Statement\UpdateStatement;
use Fate\PDO\Statement\DeleteStatement;
...
class Database extends \PDO
{
    ...
    protected function getDefaultOptions()
    {
        return array(
            ...
            \PDO::ATTR_STATEMENT_CLASS => array('Fate\\PDO\\Statement', array($this)),
        );
    }
